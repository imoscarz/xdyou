...
class _ContentClassTablePageState extends State<ContentClassTablePage> {
  ...
  void didChangeDependencies() {
    ...
    _pagingController.bind(
      weekListenable: classTableState,
      selectedWeek: () => classTableState.chosenWeek,
      semesterLength: () => classTableState.semesterLength,
      onWeekSelected: (week) => classTableState.chosenWeek = week,
      viewportWidth: ClassTableState.of(context)!.constraints.minWidth,
    );
    decoration = buildClassTableBackgroundDecoration(
      context,
      decorationName: classTableState.decorationName,
    );
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          ClassTableActionMenu(
            ...
            iCalendarText: classTableState.iCalenderStr,
            onAddClass: classTableState.addUserDefinedClass,
            onOutputToCalendar: classTableState.outputToCalendar,
            onRefreshClassTable: classTableState.updateClasstable,
